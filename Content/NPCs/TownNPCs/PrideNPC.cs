	...
	public class PrideNPC : ModNPC
	{
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
				...
				new FlavorTextBestiaryInfoElement("The Sin Of Pride But Y'know Smaller. Went Back To Normal After Getting Killed In Eye Form"),
			});
		}
        ...
        {
            Main.GetItemDrawFrame(ModContent.ItemType<AxeOfPride>(), out item, out itemFrame);
            itemSize = 40;
