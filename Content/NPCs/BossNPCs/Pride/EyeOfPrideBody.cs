...
namespace PurringTale.Content.NPCs.BossNPCs.Pride
{

    [AutoloadBossHead]
    public class EyeOfPrideBody : ModNPC

    {
        ...
        public override void SetDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                Music = MusicLoader.GetMusicSlot(Mod, "Assets/Music/Pride");
            }
        }
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
                ...
                new FlavorTextBestiaryInfoElement("The Eye Of The Sin Of Pride Gets Weaker In Second Stage"),
            });
        }

        public override void OnKill()
        {
            NPC.SetEventFlagCleared(ref DownedBossSystem.downedPride, -1);
        }
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<CoreOfPride>(), 1, 30, 60));
