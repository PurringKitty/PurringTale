...
namespace PurringTale.Content.Items.Consumables.StatItems
{
    ...
    internal class FruitOfValhalla : ModItem
	{
		public static readonly int MaxExampleLifeFruits = 4;
		public static readonly int LifePerFruit = 50;
