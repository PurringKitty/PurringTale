...
namespace PurringTale.Content.Items.Consumables
{
    ...
    public class BowlOfEnvy : ModItem
	{
		...
		public override bool CanUseItem(Player player) {
			...
			return !NPC.AnyNPCs(ModContent.NPCType<EyeOfEnvyBody>());
		}
		...
		public override bool? UseItem(Player player) {
			if (player.whoAmI == Main.myPlayer) {
				...
				int type = ModContent.NPCType<EyeOfEnvyBody>();
		...
		public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient<CoreOfValhalla>(10)
