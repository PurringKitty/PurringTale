...
namespace PurringTale.Content.Items.Consumables
{
    ...
    public class BowlOfGreed : ModItem
	{
		...
		public override bool CanUseItem(Player player) {
			...
			return !NPC.AnyNPCs(ModContent.NPCType<EyeOfGreedBody>());
		}
		...
		public override bool? UseItem(Player player) {
			if (player.whoAmI == Main.myPlayer) {
				...
				int type = ModContent.NPCType<EyeOfGreedBody>();
		...
		public override void AddRecipes() {
			CreateRecipe()
                .AddIngredient<CoreOfValhalla>(30)
