...
namespace PurringTale.Content.Items.Consumables
{
    ...
    public class BowlOfLust : ModItem
	{
		...
		public override bool CanUseItem(Player player) {
			...
			return !NPC.AnyNPCs(ModContent.NPCType<EyeOfLustBody>());
		}
		...
		public override bool? UseItem(Player player) {
			if (player.whoAmI == Main.myPlayer) {
				...
				int type = ModContent.NPCType<EyeOfLustBody>();
		...
		public override void AddRecipes() {
			CreateRecipe()
                .AddIngredient<CoreOfValhalla>(40)
