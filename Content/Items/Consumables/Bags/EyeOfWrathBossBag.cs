...
namespace PurringTale.Content.Items.Consumables.Bags
{
	public class EyeOfWrathBossBag : ModItem
    {
        ...
        {
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<ValhallaOre>(), 1, 1, 40));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<VanityVoucher>(), 5, 1, 2));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<Wrath>(), 1, 1, 1));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<WrathHelmet>(), 2, 0, 1));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<WrathBreastplate>(), 2, 0, 1));
