...
namespace PurringTale.Content.Items.Consumables
{
    ...
    public class BowlOfSloth : ModItem
	{
		...
		public override bool CanUseItem(Player player) {
			...
			return !NPC.AnyNPCs(ModContent.NPCType<EyeOfSlothBody>());
		}
		...
		public override bool? UseItem(Player player) {
			if (player.whoAmI == Main.myPlayer) {
				...
				int type = ModContent.NPCType<EyeOfSlothBody>();
		...
		public override void AddRecipes() {
			CreateRecipe()
                .AddIngredient<CoreOfValhalla>(60)
