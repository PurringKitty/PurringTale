...
namespace PurringTale.Content.Items.Armor
{
	...
	public class WeakValhallaCap : ModItem
	{
        public static int AdditiveSummonDamageBonus = 5;
        public static int MaxSentryIncrease = 1;
                    ...
                    public override void UpdateArmorSet(Player player)
        {
            ...
            player.GetDamage(DamageClass.Summon) += AdditiveSummonDamageBonus / 5f; // Increase dealt damage for all weapon classes by 20%
