...
namespace PurringTale.Content.Items.Armor
{
	...
	public class WeakValhallaHelmet : ModItem
	{
        public static readonly int AdditiveMeleeDamageBonus = 5;
        public static readonly int AdditiveCritBonus = 5;
        public static int MaxLifeIncrease = 25;
                    ...
                    public override void UpdateArmorSet(Player player)
        {
            ...
            player.GetDamage(DamageClass.Melee) += AdditiveMeleeDamageBonus / 5f; // Increase dealt damage for all weapon classes by 20%
            player.GetCritChance(DamageClass.Melee) += AdditiveCritBonus / 5f;
