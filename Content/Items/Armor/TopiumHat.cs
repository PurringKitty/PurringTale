...
namespace PurringTale.Content.Items.Armor
{
	...
	{
        public static readonly int AdditiveRangedDamageBonus = 10;
                    ...
                    public override void UpdateArmorSet(Player player)
        {
            ...
            player.GetDamage(DamageClass.Ranged) += AdditiveRangedDamageBonus / 30f; // Increase dealt damage for all weapon classes by 20%
