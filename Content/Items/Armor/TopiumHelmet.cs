...
namespace PurringTale.Content.Items.Armor
{
	...
	public class TopiumHelmet : ModItem
	{
        ...
        public static readonly int AdditiveCritChanceBonus = 10;
                    ...
                    public override void UpdateArmorSet(Player player)
        {
            ...
            player.GetDamage(DamageClass.Melee) += AdditiveMeleeDamageBonus / 30f; // Increase dealt damage for all weapon classes by 20%
            player.GetCritChance(DamageClass.Melee) += AdditiveCritChanceBonus / 20f;
    }
