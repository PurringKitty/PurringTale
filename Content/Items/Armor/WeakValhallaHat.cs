...
namespace PurringTale.Content.Items.Armor
{
	...
	public class WeakValhallaHat : ModItem
	{
        public static readonly int AdditiveRangedDamageBonus = 5;
                    ...
                    public override void UpdateArmorSet(Player player)
        {
            ...
            player.GetDamage(DamageClass.Ranged) += AdditiveRangedDamageBonus / 5f; // Increase dealt damage for all weapon classes by 20%
