...
{
	public class LustMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/Lust"), ModContent.ItemType<LustMusicBox>(), ModContent.TileType<LustMusicBoxTile>());
		}
        ...
        public override void AddRecipes()
        {
			...
			recipe.AddIngredient<Lust>(5);
            recipe.AddTile<Tiles.Furniture.ValhallaWorkbench>();
            recipe.Register();
        }
    
    public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<LustMusicBoxTile>(), 0);
		}
	}
}
