...
{
	public class GluttonyMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/Gluttony"), ModContent.ItemType<GluttonyMusicBox>(), ModContent.TileType<GluttonyMusicBoxTile>());
		}
    ...
    public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<GluttonyMusicBoxTile>(), 0);
		}
	}
}
