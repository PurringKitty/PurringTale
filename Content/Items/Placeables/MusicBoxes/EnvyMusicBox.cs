...
{
	public class EnvyMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/Envy"), ModContent.ItemType<EnvyMusicBox>(), ModContent.TileType<EnvyMusicBoxTile>());
		}
        ...
        public override void AddRecipes()
        {
			...
			recipe.AddIngredient<Envy>(5);
            recipe.AddTile<Tiles.Furniture.ValhallaWorkbench>();
            recipe.Register();
        }
    
    public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<EnvyMusicBoxTile>(), 0);
		}
	}
}
