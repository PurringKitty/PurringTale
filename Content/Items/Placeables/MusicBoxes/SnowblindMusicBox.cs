...
{
	public class SnowblindMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/SnowblindPiano"), ModContent.ItemType<SnowblindMusicBox>(), ModContent.TileType<SnowblindMusicBoxTile>());
		}
    ...
    public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<SnowblindMusicBoxTile>(), 0);
		}
	}
}
