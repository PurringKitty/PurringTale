...
{
	public class PrideMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/Pride"), ModContent.ItemType<PrideMusicBox>(), ModContent.TileType<PrideMusicBoxTile>());
		}
        ...
        public override void AddRecipes()
        {
			...
			recipe.AddIngredient<Pride>(5);
            recipe.AddTile<Tiles.Furniture.ValhallaWorkbench>();
            recipe.Register();
        }
    
    public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<PrideMusicBoxTile>(), 0);
		}
	}
}
