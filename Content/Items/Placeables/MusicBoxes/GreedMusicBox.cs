...
{
	public class GreedMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/Greed"), ModContent.ItemType<GreedMusicBox>(), ModContent.TileType<GreedMusicBoxTile>());
		}
        ...
        public override void AddRecipes()
        {
			...
			recipe.AddIngredient<Greed>(5);
            recipe.AddTile<Tiles.Furniture.ValhallaWorkbench>();
            recipe.Register();
        }
    
    public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<GreedMusicBoxTile>(), 0);
		}
	}
}
