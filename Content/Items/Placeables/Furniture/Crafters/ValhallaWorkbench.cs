...
namespace PurringTale.Content.Items.Placeables.Furniture.Crafters
{
    public class ValhallaWorkbench : ModItem
	{
		public override void SetDefaults() {
			...
			Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.Furniture.Crafters.ValhallaWorkbench>());
