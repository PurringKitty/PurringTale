...
{
	public class LastAeigisHoldout : ModProjectile
	{
		...
		private void FireBeams() {
			...
			for (int b = 0; b < NumBeams; ++b) {
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, beamVelocity, ModContent.ProjectileType<LastAeigisBeam>(), damage, knockback, Projectile.owner, b, uuid);
			}
		...
		public override bool PreDraw(ref Color lightColor) {
			...
			Color drawColor = LastAeigis.OverrideColor;
