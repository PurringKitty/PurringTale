...
namespace PurringTale.Content.Projectiles.MinionProjectiles
{
    public class BrainMinionProj : ModProjectile
    {
        ...
        readonly float idleRange = 10f;      // The range in which the minion will idle over the player
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<BrainMinionBuff>());

                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<BrainMinionBuff>()))
            {
