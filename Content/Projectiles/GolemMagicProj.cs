...
{
	public class GolemMagicProj : ModProjectile
	{
...
#pragma warning disable IDE0034 // Simplify 'default' expression
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.GreenBlood, 0f, 0f, 0, default(Color), 1f);
