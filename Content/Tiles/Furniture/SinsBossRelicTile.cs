...
namespace PurringTale.Content.Tiles.Furniture
{
	...
	public class SinsBossRelicTile : ModTile
	{
		...
		public virtual string RelicTextureName => "PurringTale/Content/Tiles/Furniture/SinsBossRelicTile";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "PurringTale/Content/Tiles/Furniture/RelicPedestal";
