...
namespace PurringTale.Content.Tiles
{
    public class GlitchTree : ModTree
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            texture = ModContent.Request<Texture2D>("PurringTale/Content/Tiles/GlitchTree");
            branchesTexture = ModContent.Request<Texture2D>("PurringTale/Content/Tiles/GlitchTree_Branches");
            topsTexture = ModContent.Request<Texture2D>("PurringTale/Content/Tiles/GlitchTree_Tops");
        }
