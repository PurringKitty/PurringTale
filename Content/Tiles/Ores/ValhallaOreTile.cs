...
namespace PurringTale.Content.Tiles.Ores
{
    public class ValhallaOreTile : ModTile
    {
...
public class WeakValhallaOrePass : GenPass
{
    ...
    protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
    {
        ...
        for (int k = 0; k < (int)(Main.maxTilesX * Main.maxTilesY * 6E-05); k++)
        {
            ...
            WorldGen.TileRunner(x, y, WorldGen.genRand.Next(5, 10), WorldGen.genRand.Next(7, 15), ModContent.TileType<ValhallaOreTile>());
