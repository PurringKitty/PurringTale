...
namespace PurringTale.Common.Players
{
	public class ExampleStatIncreasePlayer : ModPlayer
	{
		...
		public override void ModifyMaxStats(out StatModifier health, out StatModifier mana) {
			...
			health.Base = exampleLifeFruits * FruitOfValhalla.LifePerFruit;
			// Alternatively:  health = StatModifier.Default with { Base = exampleLifeFruits * ExampleLifeFruit.LifePerFruit };
			mana = StatModifier.Default;
			mana.Base = exampleManaCrystals * CrystalOfValhalla.ManaPerCrystal;
		...
		public override void SyncPlayer(int toWho, int fromWho, bool newPlayer) {
			...
			//packet.Write((byte)PurringTail.MessageType.ExampleStatIncreasePlayerSync);
